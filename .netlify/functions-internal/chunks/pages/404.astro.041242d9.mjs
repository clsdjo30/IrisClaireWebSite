...
/* empty css                            *//* empty css                         */
const $$Astro$o = createAstro("https://chimerical-caramel-133df7.netlify.app");
...
const $$Astro$n = createAstro("https://chimerical-caramel-133df7.netlify.app");
...
const $$Astro$m = createAstro("https://chimerical-caramel-133df7.netlify.app");
...
const $$Astro$l = createAstro("https://chimerical-caramel-133df7.netlify.app");
...
const $$Astro$k = createAstro("https://chimerical-caramel-133df7.netlify.app");
...
const $$Astro$j = createAstro("https://chimerical-caramel-133df7.netlify.app");
...
const $$Astro$i = createAstro("https://chimerical-caramel-133df7.netlify.app");
...
const $$Astro$h = createAstro("https://chimerical-caramel-133df7.netlify.app");
...
const $$Astro$g = createAstro("https://chimerical-caramel-133df7.netlify.app");
...
const $$Astro$f = createAstro("https://chimerical-caramel-133df7.netlify.app");
...
const $$Astro$e = createAstro("https://chimerical-caramel-133df7.netlify.app");
...
const $$Astro$d = createAstro("https://chimerical-caramel-133df7.netlify.app");
...
const $$Astro$c = createAstro("https://chimerical-caramel-133df7.netlify.app");
...
const $$Astro$b = createAstro("https://chimerical-caramel-133df7.netlify.app");
...
const $$Astro$a = createAstro("https://chimerical-caramel-133df7.netlify.app");
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <div class="container mx-auto flex flex-col justify-center items-start space-y-26 px-26 pb-8 pt-12 md:flex-row md:space-y-0 md:space-x-0 md:px-12">
    ...
    <div class="w-full text-center text-violet-200 md:w-1/5 md:text-left mt-10 md:mt-0">
      ...
      <ul class="flex md:flex-col justify-center gap-10 md:gap-0 text-xs">
        <li class="pt-3">
          <a class="underline decoration-transparent underline-offset-4 transition hover:decoration-slate-700" href="#" rel="noopener noreferrer" target="_blank">
            About
          </a>
        </li>
        <li class="pt-3">
    ...
    <div class="w-full text-center text-violet-200 md:w-1/5 md:text-left mt-5 md:mt-0">
      ...
      <div class="flex justify-center md:justify-start gap-4 mt-3">
        <div class="flex items-center gap-4">
          ${renderComponent($$result, "Link", $$Link, { "href": "https://www.instagram.com/", "size": "sm", "style": "muted", "target": "_blank" }, { "default": ($$result2) => renderTemplate`
            ${renderComponent($$result2, "Icon", $$Icon, { "name": "bx:bxl-instagram", "class": "text-violet-800 hover:text-orange-500 h-6 w-6" })}
          ` })}
          ${renderComponent($$result, "Link", $$Link, { "href": "https://www.pinterest.fr/Djodjo30/", "size": "sm", "style": "muted", "target": "_blank" }, { "default": ($$result2) => renderTemplate`
            ${renderComponent($$result2, "Icon", $$Icon, { "name": "bx:bxl-pinterest", "class": "text-violet-800 hover:text-orange-500 h-6 w-6" })}
          ` })}
          ${renderComponent($$result, "Link", $$Link, { "href": "https://www.facebook.com/", "size": "sm", "style": "muted", "target": "_blank" }, { "default": ($$result2) => renderTemplate`
            ${renderComponent($$result2, "Icon", $$Icon, { "name": "bx:bxl-facebook", "class": "text-violet-800 hover:text-orange-500 h-6 w-6" })}
          ` })}
        </div>
      </div>
    </div>
  ...
  <div class="container mx-auto border-t border-slate-200 p-8 text-center text-sm text-violet-200 dark:border-violet-200 md:flex-row md:px-12">
    Made in Montpellier with 🐕  ©Copyright 2023 by DIGIX SAS. All rights reserved.
  </div>
</footer>`;
}, "C:/Users/leser/REACT_ NATIVE/IRIS_CLAIRE/IrisClaireWebSite/src/components/footer.astro");

const $$Astro$9 = createAstro("https://chimerical-caramel-133df7.netlify.app");
...
const $$Astro$8 = createAstro("https://chimerical-caramel-133df7.netlify.app");
...
const $$Astro$7 = createAstro("https://chimerical-caramel-133df7.netlify.app");
...
const $$Astro$6 = createAstro("https://chimerical-caramel-133df7.netlify.app");
...
const $$Astro$5 = createAstro("https://chimerical-caramel-133df7.netlify.app");
  ...
  ${maybeRenderHead()}<header class="flex flex-col lg:flex-row justify-between items-center my-5 mx-5 md:px-32">
    ${renderComponent($$result2, "Astronav", $$Astronav, {}, { "default": ($$result3) => renderTemplate`
      ...
      ${renderComponent($$result3, "MenuItems", $$MenuItems, { "class": "hidden w-full lg:w-auto mt-2 lg:flex lg:mt-0" }, { "default": ($$result4) => renderTemplate`
        ...
        <div class="lg:hidden flex items-center mt-3 gap-4">
          ${renderComponent($$result4, "Link", $$Link, { "href": "https://www.instagram.com/", "size": "sm", "style": "muted", "target": "_blank" }, { "default": ($$result5) => renderTemplate`
            ${renderComponent($$result5, "Icon", $$Icon, { "name": "bx:bxl-instagram", "class": "text-violet-800 hover:text-orange-500 h-6 w-6" })}
          ` })}
          ${renderComponent($$result4, "Link", $$Link, { "href": "https://www.pinterest.fr/Djodjo30/", "size": "sm", "style": "muted", "target": "_blank" }, { "default": ($$result5) => renderTemplate`
            ${renderComponent($$result5, "Icon", $$Icon, { "name": "bx:bxl-pinterest", "class": "text-violet-800 hover:text-orange-500 h-6 w-6" })}
          ` })}
          ${renderComponent($$result4, "Link", $$Link, { "href": "https://www.facebook.com/", "size": "sm", "style": "muted", "target": "_blank" }, { "default": ($$result5) => renderTemplate`
    ...
    <div>
      <div class="hidden lg:flex items-center gap-4">
        ${renderComponent($$result2, "Link", $$Link, { "href": "https://www.instagram.com/", "size": "sm", "style": "muted", "target": "_blank" }, { "default": ($$result3) => renderTemplate`
          ${renderComponent($$result3, "Icon", $$Icon, { "name": "bx:bxl-instagram", "class": "text-violet-800 hover:text-orange-500 h-6 w-6" })}
        ` })}
        ${renderComponent($$result2, "Link", $$Link, { "href": "https://www.pinterest.fr/Djodjo30/", "size": "sm", "style": "muted", "target": "_blank" }, { "default": ($$result3) => renderTemplate`
          ${renderComponent($$result3, "Icon", $$Icon, { "name": "bx:bxl-pinterest", "class": "text-violet-800 hover:text-orange-500 h-6 w-6" })}
        ` })}
        ${renderComponent($$result2, "Link", $$Link, { "href": "https://www.facebook.com/", "size": "sm", "style": "muted", "target": "_blank" }, { "default": ($$result3) => renderTemplate`
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Layout;
  const canonicalURL = new URL("https://chimerical-caramel-133df7.netlify.app/", Astro2.site).toString();
  const resolvedImageWithDomain = new URL(
    "/opengraph.jpg",
    Astro2.site
  ).toString();
  const { title } = Astro2.props;
  const makeTitle = title ? title + " | Astroship" : "Iris Claire - Votre Portail vers l'Univers Mystique du Tarot";
  return renderTemplate`<html lang="en">
  <head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width">
    <link rel="icon" type="image/svg+xml" href="/iris_003.png">
