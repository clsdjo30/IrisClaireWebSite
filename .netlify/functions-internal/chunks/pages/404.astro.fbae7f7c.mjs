  ...
  <div class="container mx-auto flex flex-col justify-center items-start space-y-26 px-26 pb-8 pt-12 md:flex-row md:space-y-0 md:space-x-0 md:px-12">
    ...
    <div class="w-full text-center text-violet-200 md:w-1/5 md:text-left mt-5 md:mt-0">
      ...
      <div class="flex justify-center md:justify-start gap-4 mt-3">
        ${renderComponent($$result, "Icon", $$Icon, { "name": "bx:bxl-instagram", "class": "text-violet-200 h-8 w-8" })}
        ${renderComponent($$result, "Icon", $$Icon, { "name": "bx:bxl-facebook", "class": "text-violet-200 h-8 w-8" })}
        ${renderComponent($$result, "Icon", $$Icon, { "name": "bx:bxl-pinterest", "class": "text-violet-200 h-8 w-8" })}
      </div>
    </div>
  </div>
...
}, "C:/Users/leser/REACT_ NATIVE/IRIS_CLAIRE/IrisClaireWebSite/src/components/navbar/dropdown.astro");
...
export { $$Layout as $, _404 as _, $$Container as a, $$Icon as b };
