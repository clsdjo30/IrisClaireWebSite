...
import { a as $$SEO, b as $$Navbar, c as $$Footer } from './404.astro.041242d9.mjs';
/* empty css                            *//* empty css                            */import { $ as $$BlogContainer, B as BlogAsideSection } from './_category_.astro.a1058c57.mjs';
...
const $$BlogLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const makeUrl = new URL(image, Astro2.site).toString();
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$BlogLayout, { "title": title, "image": featureImage.data[0].attributes?.url, "description": description, "imageAlt": imagedescription, "author": author.data.attributes?.name }, { "default": ($$result2) => renderTemplate`
  ${renderComponent($$result2, "Container", $$BlogContainer, { "class": "w-full md:w-10/12 bg-slate-100 h-auto mb-10" }, { "default": ($$result3) => renderTemplate`
    ${maybeRenderHead()}<div class="container w-full mx-auto flex flex-wrap pt-6">
      ...
      ${renderComponent($$result3, "Aside", BlogAsideSection, { "categoriesList": categoriesList, "latestPosts": latestPosts, "categorySlug": categorySlug })}
    </div>
  ` })}
` })}`;
