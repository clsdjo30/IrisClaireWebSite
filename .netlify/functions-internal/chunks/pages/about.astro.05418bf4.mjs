...
/* empty css                         */import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, s as spreadAttributes, b as addAttribute, d as renderSlot, g as createCollectionToGlobResultMap, h as createGetCollection, e as renderComponent, F as Fragment } from '../astro.6b89a777.mjs';
...
async function getImage(transform) {
  ...
  if (!loader) {
    const { default: mod } = await import('./endpoint.js.24198bef.mjs').then(n => n.s).catch(() => {
      throw new Error(
...
let lookupMap = {};
lookupMap = {"blog":{"type":"content","entries":{"faut-il-etre-ami-avant-d-etre-en-couple":"/src/content/blog/faut-il-etre-ami-avant-d-etre-en-couple.md","triangle-amoureux-comment-sen-sortir":"/src/content/blog/triangle-amoureux-comment-sen-sortir.md"}},"team":{"type":"content","entries":{"janette-lynch":"/src/content/team/janette-lynch.md","marcell-ziemann":"/src/content/team/marcell-ziemann.md","robert-palmer":"/src/content/team/robert-palmer.md"}}};
...
export { $$Sectionhead as $, BaseSSRService as B, isRemoteImage as a, $$Picture as b, about as c, isOutputFormatSupportsAlpha as i };
