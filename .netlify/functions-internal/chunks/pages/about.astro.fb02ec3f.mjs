...
async function getImage(transform) {
  ...
  if (!loader) {
    const { default: mod } = await import('./endpoint.js.e23d2853.mjs').then(n => n.s).catch(() => {
      throw new Error(
...
let lookupMap = {};
lookupMap = {"blog":{"type":"content","entries":{"faut-il-etre-ami-avant-d-etre-en-couple":"/src/content/blog/faut-il-etre-ami-avant-d-etre-en-couple.md","triangle-amoureux-comment-sen-sortir":"/src/content/blog/triangle-amoureux-comment-sen-sortir.md"}},"team":{"type":"content","entries":{"robert-palmer":"/src/content/team/robert-palmer.md","janette-lynch":"/src/content/team/janette-lynch.md","marcell-ziemann":"/src/content/team/marcell-ziemann.md"}}};
